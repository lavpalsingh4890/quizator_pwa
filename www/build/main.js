...
var HomePage = /** @class */ (function () {
    function HomePage(toastCtrl, modal, alertCtrl, iab, navCtrl, http) {
        this.toastCtrl = toastCtrl;
        this.modal = modal;
        this.alertCtrl = alertCtrl;
        this.iab = iab;
