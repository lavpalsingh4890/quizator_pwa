...
var TagnamePage = /** @class */ (function () {
    function TagnamePage(toastCtrl, http, navCtrl, navParams) {
        this.toastCtrl = toastCtrl;
        this.http = http;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
